...
public class PersonalActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mList = new ArrayList<>();
       // adapter = new GroupDoAdapter(this, fragmentManager, mList, "Personal");

        adapter = new GroupDoAdapter(this, getSupportFragmentManager(), mList, "Personal", new CategoryClickListener() {
            @Override

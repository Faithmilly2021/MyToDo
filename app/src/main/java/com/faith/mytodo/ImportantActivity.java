...
public class ImportantActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().hasExtra("task")) {
            ...
            // Display the task details in your layout views
            // For example:
       ...
       // importantTaskAdapter = new ToDoAdapter(this, importantTasksList, true);
        ...
        fetchImportantTasksFromFirestore();
    }

    private void fetchImportantTasksFromFirestore() {
        CollectionReference tasksCollection = firestore.collection("tasks");

        tasksCollection.whereEqualTo("isImportant", true)
